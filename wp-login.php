...
<link rel="stylesheet" id="forms-css" href="/wp-admin/css/forms.min.css?ver=5.9.2" type="text/css" media="all">
<link rel="stylesheet" id="l10n-css" href="/wp-admin/css/l10n.min.css?ver=5.9.2" type="text/css" media="all">
<link rel="stylesheet" id="login-css" href="/wp-admin/css/login.min.css?ver=5.9.2" type="text/css" media="all">
		...
		<form name="loginform" id="loginform" action="/wp-login.php" method="post">
			...
			<p class="submit">
				<input type="submit" name="wp-submit" id="wp-submit" class="button button-primary button-large" value="Log In">
									<input type="hidden" name="redirect_to" value="/wp-admin/customize.php">
									<input type="hidden" name="testcookie" value="1">
			</p>
		</form>

					<p id="nav">
								<a href="/mon-espace/lost-password/">Lost your password?</a>
			</p>
					<script type="text/javascript">
...
if ( typeof wpOnload === 'function' ) { wpOnload() }		</script>
				<p id="backtoblog">
			<a href="/">&larr; Go to Vers l&#039;infini et au delà</a>		</p>
			</div>
...
<script type="text/javascript" src="/wp-admin/js/password-strength-meter.min.js?ver=5.9.2" id="password-strength-meter-js"></script>
...
<script type="text/javascript" src="/wp-admin/js/user-profile.min.js?ver=5.9.2" id="user-profile-js"></script>
	<script>
